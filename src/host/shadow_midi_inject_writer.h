 ...
 *
 * The inject ring is multi-producer / single-consumer. Producers live in
 * three different processes (shim, schwung_host, schwung-testd) and may
 * call concurrently. Without coordination they race on the cursor or
