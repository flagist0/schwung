 ...
 *
 * Lives in a separate translation unit so each new Phase 2/3 channel
 * (MIDI_IN, log tail, etc.) lands here instead of growing schwung_shim.c.
 * See flagist0/schwung#2 for the design context.
 */
